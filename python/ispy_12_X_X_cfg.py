...
process = cms.Process('ISPY',Run3_pp_on_PbPb_2023)
...
process.source = cms.Source(
    ...
    # 'root://cmsxrootd.fnal.gov//store/data/Run2018B/Charmonium/AOD/17Sep2018-v1/120000/3ADC2E5A-4F1B-4546-8CB6-58DDBBC921D3.root'
      'file:/eos/home-a/abaty/ppMINIAOD_Test/2023_AOD_monsterEventTest.root'
    )
...
process.ISpyPFJet.etMin = cms.double(5.0) # 30.0
...
process.ISpyTrackExtrapolation.trackPtMin = cms.double(0.5) # 2.0
